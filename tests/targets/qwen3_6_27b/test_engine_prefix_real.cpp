...
int exercise_auto_save_evicted(const char* artifact) {
    ...
    const ninfer::ChatMessage assistant1 = text_message(ninfer::ChatRole::Assistant, first.content);
    const ninfer::ChatMessage turn2 =
        text_message(ninfer::ChatRole::User, "Now two metals. Be brief.");
    const ninfer::GenerationResult second =
